...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/igo2.css">
...
<div>
    <h1 class="titulocards">iGo 2</h1>
</div>

<div class="conteudo">
    <div class="conteudo1">
        <p>O iGo2 é um dispositivo de comunicação utilizado em equipamentos e pontos críticos que exigem controle de fluxo ou acesso.</p>
