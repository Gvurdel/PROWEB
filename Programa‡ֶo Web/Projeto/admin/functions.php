...
//Inserir o usuário no BD
            ...
            if ($executar) {
                ?>
            <div class="msg-erro">Usuário Cadastrado com sucesso!
            </div>
            <style>
                .msg-erro{ 
                    text-align: center;
            ...
            <?php
                ...
                ?>
            <div class="msg-erro">Erro ao inserir Usuário!
            </div>
            <style>
                .msg-erro{ 
                    text-align: center;
...
function deletar($connect, $tabela, $id){
    if (!empty($id)){
        ...
        if ($executar) { 
            ?>
            <div class="msg-erro">Dado deletado com sucesso!
            </div>
            <style>
                .msg-erro{ 
                    text-align: center;
            ...
            ?>
            <div class="msg-erro">Erro ao deletar!
            </div>
            <style>
                .msg-erro{ 
                    text-align: center;
