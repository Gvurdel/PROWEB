...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/gohome.css">
...
<div>
    <h1 class="titulocards">Go Home</h1>
</div>
...
<div class="conteudo">
    ...
    <P>Aqui estão algumas das características-chave e vantagens deste sistema:</p><br>
        <h3>Go Home</h3>
        <ul>
